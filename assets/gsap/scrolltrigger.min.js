...
!(function (e, t) {
  ...
  function Q(e, t) {
    ...
    return (r = "scroll" + n) && (i = L(e, r))
      ? i() - N(e)()[o]
      : K(e)
      ? Math.max(Pe[r], Oe[r]) - (Me["inner" + n] || Pe["client" + n] || Oe["client" + n])
      : e[r] - e["offset" + n];
  }
  function R(e, t) {
  ...
  function gb(e, t, r, n, o, i, a, s, l, c, f, u) {
    ...
    if (i) {
      ...
      (u = "scroll" + n.d2),
        ...
        f && ((l = nt(a)), f && (i.style[n.op.p] = l[n.op.p] - n.op.m - i._offset + et));
    }
    return Math.round(e);
  }
  function jb(l, e) {
  ...
  var ke,
    ...
    A = function _revertAll(e, t) {
      ...
      for (ze = 0; ze < at.length; ze++)
        (r = at[ze]),
          (t && r.media !== t) || (e ? r.kill(1) : (r.scroll.rec || (r.scroll.rec = r.scroll()), r.revert()));
      E(t), t || P("revert");
    },
    ...
    B = function _updateAll() {
      ...
      if (
        ((lt = n < q ? -1 : 1),
        (q = n),
        r && (De && !Ae && 200 < t - De && ((De = 0), P("scrollEnd")), (Ie = v), (v = t)),
        lt < 0)
      ) {
  ...
  var Y =
    ((ScrollTrigger.prototype.init = function init(b, y) {
      if (((this.progress = 0), this.vars && this.kill(1), Je)) {
        var d,
          ...
          G,
          ee,
          te = (b = sa(S(b) || U(b) || b.nodeType ? { trigger: b } : b, it)).horizontal ? tt : rt,
          re = b.onUpdate,
          ne = b.toggleClass,
          i = b.id,
          oe = b.onToggle,
        ...
        (Te.media = Be),
          ...
          (u.tweenScroll = u.tweenScroll || { top: jb(he, rt), left: jb(he, tt) }),
          ...
          se &&
            (!1 === le || le === Ze || (le = !(!le && "flex" === qa(se.parentNode).display) && $e),
            (Te.pin = se),
          ...
          (Te.revert = function (e) {
            var t = !1 !== e || !Te.enabled,
              r = Re;
            t !== w &&
              (t && ((G = Math.max(Te.scroll(), Te.scroll.rec || 0)), (Z = Te.progress), (ee = y && y.progress())),
              O &&
          ...
          (Te.refresh = function (e) {
            if (!Re && Te.enabled)
              if (se && e && De) xa(ScrollTrigger, "scrollEnd", Qa);
                ...
                for (
                  _ = gb(v, ae, c, te, Te.scroll(), O, I, Te, f, ye, ve, u) || (se ? -0.001 : 0),
                    T(g) && (g = g(Te)),
                    S(g) &&
                      !g.indexOf("+=") &&
                      (~g.indexOf(" ")
                        ? (g = (S(v) ? v.split(" ")[0] : "") + g)
                        : ((p = Ca(g.substr(2), c)), (g = S(v) ? v : _ + p), (h = ae))),
                    P =
                      Math.max(_, gb(g || (h ? "100% 0" : u), h, c, te, Te.scroll() + p, E, R, Te, f, ye, ve, u)) ||
                      -0.001,
                    A = P - _ || ((_ -= 0.01) && 0.001),
                    p = 0,
                    m = x;
                  ...
                  (s = (a = at[m]).pin) &&
                    ...
                    ((t = a.end - a.start), s === ae && (p += t), s === se && (d += t));
                if (
                  ((_ += p),
                  (P += p),
                  (Te._pinPush = d),
                  ...
                  for (r = ae.parentNode; r && r !== Oe; )
                    r._pinOffset && ((_ -= r._pinOffset), (P -= r._pinOffset)), (r = r.parentNode);
                ...
                (Te.start = _),
                  ...
                  Z !== Te.progress && (Y && y.totalProgress(Z, !0), (Te.progress = Z), Te.update()),
          ...
          (Te.update = function (e, t) {
            var r,
              ...
              f = Te.progress;
            if (
              (t && ((k = C), (C = s), pe && ((X = m), (m = y && !ge ? y.totalProgress() : c))),
              fe && !c && se && !Re && !Fe && De && _ < s + ((s - k) / (He() - Ie)) * fe && (c = 1e-4),
              c !== f && Te.enabled)
            ) {
              if (
                ((i = (a = (r = Te.isActive = !!c && c < 1) != (!!f && f < 1)) || !!c != !!f),
    ...
    (ScrollTrigger.register = function register(e) {
      if (
        !o &&
        ((ke = e || J()),
        I() && window.document && ((Me = window), (_e = document), (Pe = _e.documentElement), (Oe = _e.body)),
        ke && ((Ee = ke.utils.toArray), (Le = ke.utils.clamp), ke.core.globals("ScrollTrigger", ScrollTrigger), Oe))
      ) {
        (s =
