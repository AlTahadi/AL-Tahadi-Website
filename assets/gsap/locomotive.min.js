!(function (t, e) {
      ...
      t % 2
        ? e(Object(o), !0).forEach(function (t) {
            ...
            (e = n),
              (s = o[(i = t)]),
              i in e
                ? Object.defineProperty(e, i, { value: s, enumerable: !0, configurable: !0, writable: !0 })
                : (e[i] = s);
          })
            ...
            value: function (t) {
              t.preventDefault(),
                this.scrollTo(
                  ...
                  t.currentTarget.getAttribute("data-".concat(this.name, "-offset"))
                );
            },
          },
            ...
            value: function (t, e) {
              (this.els[e].inView = !0),
                ...
                t.repeat ||
                  t.speed ||
                  t.sticky ||
                  ((!t.call || (t.call && this.hasCallEventSet)) && (this.els[e] = null));
            },
          },
          {
            key: "setOutOfView",
      ...
      t.exports = {
        polyfill: function () {
                ...
                if (!0 !== s(arguments[0])) {
                  var t = (function (t) {
                      for (
                        ;
                        t !== c.body &&
                        !1 === ((i = n((e = t), "Y") && o(e, "Y")), (s = n(e, "X") && o(e, "X")), i || s);
                  ...
                  t !== c.body
                    ? (r.call(this, t, t.scrollLeft + i.left - e.left, t.scrollTop + i.top - e.top),
          ...
          function r(t, e, i) {
            ...
            (l =
              t === c.body
                ? ((n = (s = a).scrollX || a.pageXOffset), (o = a.scrollY || a.pageYOffset), h.scroll)
                : ((n = (s = t).scrollLeft), (o = t.scrollTop), d)),
              f({ scrollable: s, method: l, startTime: r, startX: n, startY: o, x: e, y: i });
          }
        },
      };
    }),
          ...
          o(i, [
            ...
            },
            {
              ...
              value: function () {
                window.pageYOffset != this.instance.scroll.y
                  ? (this.instance.speed =
                      (window.pageYOffset - this.instance.scroll.y) / (Date.now() - this.timestamp))
            ...
            },
            {
              ...
              value: function (t, e, i, s, n, o) {
                ...
                if (
                  ((r = "number" != typeof l ? l.getBoundingClientRect().top + r + this.instance.scroll.y : l + r), o)
                ) {
                  r = r.toFixed();
  ...
  k.prototype = {
    ...
    emit: function (t) {
      for (
        var e = [].slice.call(arguments, 1), i = ((this.e || (this.e = {}))[t] || []).slice(), s = 0, n = i.length;
        s < n;
        s++
      )
  ...
  (P.prototype._notify = function (t) {
    ...
    (e.x += e.deltaX),
      (e.y += e.deltaY),
      this._emitter.emit(x, { x: e.x, y: e.y, deltaX: e.deltaX, deltaY: e.deltaY, originalEvent: t });
  }),
      ...
      function s(t) {
        ...
        return 0.001 <= n
          ...
          : (function (t, e, i, s, n) {
              for (
                var o, l, r = 0;
                0 < (o = U((l = e + (i - e) / 2), s, n) - t) ? (i = l) : (e = l), Math.abs(o) > F && ++r < W;
        ...
        o(n, [
            ...
            value: function () {
              ...
              if (
                ...
                !this.animatingScroll &&
                  ((e < 0.5 && 0 != this.instance.delta.y) || (e < 0.5 && 0 == this.instance.delta.y)) &&
                  this.stopScrolling();
          ...
          },
          {
            ...
            value: function () {
              this.instance.delta.y != this.instance.scroll.y
                ? (this.instance.speed =
                    (this.instance.delta.y - this.instance.scroll.y) / Math.max(1, Date.now() - this.timestamp))
                : (this.instance.speed = 0);
            },
          },
          {
                  ...
                  k.sections[S].el.querySelectorAll("[data-".concat(k.name, "]")).forEach(function (t, e) {
                    ...
                    var p =
                        (i = k.sections[S].inView
                          ? s.getBoundingClientRect().top + k.instance.scroll.y - X(s).y
                          : s.getBoundingClientRect().top - X(k.sections[S].el).y - X(s).y) + s.offsetHeight,
                      y = (p - i) / 2 + i;
                    if (h) {
                    ...
                    if (d)
                      for (var w = 0; w < d.length; w++)
                        "string" == typeof d[w]
                          ? d[w].includes("%")
                            ? (g[w] = parseInt((d[w].replace("%", "") * k.windowHeight) / 100))
                            : (g[w] = parseInt(d[w]))
                          : (g[w] = d[w]);
                    var b = {
                      el: t,
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              !(function t() {
                var e = (Date.now() - y) / n;
                1 < e
                  ? (p(1), (s.animatingScroll = !1), 0 == n && s.update(), r && r())
